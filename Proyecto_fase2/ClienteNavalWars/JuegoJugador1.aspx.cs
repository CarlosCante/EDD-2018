...
public partial class JuegoJugador1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       if(servidor.ConsultarTurno() == 1)
       {
           ...
           {
               if (servidor.MoverPieza(TextBoxColumOrigen.Text, Convert.ToInt32(TextBoxFilaOrigen.Text), Convert.ToInt32(TextBoxNivelOrigen.Text), TextBoxColumDestino.Text, Convert.ToInt32(TextBoxFilaDestino.Text), Convert.ToInt32(TextBoxNivelDestino.Text), 1))
               {
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            LabelMensajeAtaque.Text = servidor.Atacar(TextBoxColumOrigen0.Text, Convert.ToInt32(TextBoxFilaOrigen0.Text), Convert.ToInt32(TextBoxNivelOrigen0.Text), TextBoxColumDestino0.Text, Convert.ToInt32(TextBoxFilaDestino0.Text), Convert.ToInt32(TextBoxNivelDestino0.Text), 1, 2);
        }
        else
        {
